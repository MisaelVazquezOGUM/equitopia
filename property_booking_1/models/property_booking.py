        ...
        for rec in self:
            if rec.state == 'cancel':
                ...
                if len(proplist) > 1:
                    ...
                    raise Warning(_('Please select Property which are Merged!'))
        return True
...
class AccountAssetAsset(models.Model):
    ...
    def _compute_available_property(self):
        ...
        for property_brw in self:
            total = property_brw.search_count(
                [('parent_id', '=', property_brw.id), ('state', '=', 'draft')])
            property_brw.available_property = total
    ...
    def _compute_book_property(self):
        ...
        for property_brw in self:
            ...
            property_brw.book_property = total
