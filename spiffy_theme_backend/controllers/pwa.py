...
class PwaMain(http.Controller):
    ...
    def service_worker(self):
        ...
        content = qweb.render('spiffy_theme_backend.service_worker', {
    ...
    @http.route('/spiffy_theme_backend/<int:company_id>/manifest.json', type='http', auth="public", website=True)
    def manifest(self, company_id=None):
        ...
        pwashortlistas = company.pwa_shortcuts_ids
