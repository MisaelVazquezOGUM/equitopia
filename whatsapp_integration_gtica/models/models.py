...
class SaleOrder(models.Model):
    ...
    def price_list_report(self, price_list, qty, product_categories_ids):
        values = self.env['report.whatsapp_product_list'].get_report_values(price_list, qty, product_categories_ids)
