...
{
    'name': 'Theme Vouge Corporate',
    'category': 'Theme/Corporate',
    'version': '13.0.0.2',
    'author': 'Bizople Solutions Pvt. Ltd.',
    'website': 'https://www.bizople.com',
    'summary': 'Theme Vouge Corporate is featured with corporate functionalities and fully responsive to all devices. Theme Vouge Bussiness is perfect for any corporate business like It-Solution, Creative Agency, Real Estate, Travel, Yoga, etc, it will work for any corporate business.',    
    'description': """Theme Vouge Corporate is featured with corporate functionalities and fully responsive to all devices. Theme Vouge Bussiness is perfect for any corporate business like It-Solution, Creative Agency, Real Estate, Travel, Yoga, etc, it will work for any corporate business.""",
    'depends': [
        'vouge_corporate_theme_common',
    ],
    'data': [
            'views/assets.xml',
    ...
    'demo': [
            ...
            'views/vouge_demo.xml',
            'views/index.xml',
    ],
    
    'images': [
        'static/description/vouge_corporate_cover.jpg',
        'static/description/vouge_corporate_screenshot.jpg',
