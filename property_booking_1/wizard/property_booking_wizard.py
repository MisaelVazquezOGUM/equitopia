...
class PropertWizard(models.TransientModel):
    ...
    def property_change(self):
        ...
        if self.property_id:
            ...
            property_ids.append((6, 0, prop_ids.ids))
            self.property_created_ids = property_ids
...
class PropertyParentMergeWizard(models.TransientModel):
    ...
    def onchange_property(self):
        if self.new_prop_id:
            ...
            return {'domain': {
                'new_property_created_ids': [('id', 'in', property_ids)],
                'main_property_id': [('id', 'in', property_ids)]
            }
            }
